...
const Home = () => {
    ...
    return (
        ...
        <>
                ...
                udata ?
                    <>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <strong>{udata.name}</strong>  Booked Succesfully!
            ...
            <div className="mt-5">
            <div><h1 class="text-center text-white" >STADIUM SEAT BOOKING SYSTEM</h1></div>
                <div className="container">
                    <div className="add_btn mt-2 mb-2">
                        <NavLink to="/register" className="btn btn-primary">Book-Ticket</NavLink>
                    </div>
                        ...
                        <tbody>

                            {
                                getuserdata.map((element, id) => {
                                    return (
                                        <>
                                            <tr class="text-primary bg-dark fw-bold">
