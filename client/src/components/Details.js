...
const Details = () => {
    ...
    return (
        <div className="container mt-3">
            <h1 style={{ fontWeight: 400, color:"white" } }>Welcome User</h1>
                ...
                <CardContent>
                    ...
                    <div className="row">
                        ...
                        <div className="right_view  col-lg-6 col-md-6 col-12">
                            ...
                            <p className="mt-5">Seat-No: <span> {getuserdata.mobile}</span></p>
                            <p className="mt-3"><LocationOnIcon />location: <span>{getuserdata.add}</span></p>
                            <p className="mt-3">Review: <span>{getuserdata.desc}</span></p>
                        </div>
                    </div>
