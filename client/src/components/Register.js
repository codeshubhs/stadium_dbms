...
const Register = () => {
    ...
    const addinpdata = async (e) => {
        ...
        const { name, email, price, add, mobile, desc, age } = inpval;
        ...
        if (name == "") {
            ...
            const res = await fetch("/create", {
                ...
                body: JSON.stringify({
                    name, email, price, add, mobile, desc, age
                })
            });
            ...
            <form className="mt-4">
                <div className="row">
                    ...
                    <div class="mb-3 col-lg-12 col-md-12 col-12">
                        ...
                        <textarea type="text" name='desc' value={inpval.desc} onChange={setdata} className="form-control" id="" cols="30" rows="5"></textarea>
                    </div>
